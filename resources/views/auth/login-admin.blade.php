    ...
    <div class="relative bg-white/20 backdrop-blur-md rounded-xl shadow-lg p-10 w-full max-w-sm text-center z-10">
        ...
        <form method="POST" action="{{ route('login.admin.submit') }}" class="space-y-4">
            ...
            <div class="text-right">
                <a href="{{ route('password.request') }}" class="text-sm text-white/80 hover:text-yellow-400">Forgot Password?</a>
            </div>
        ...
        <p class="mt-4 text-sm text-white/80">
            <a href="{{ route('role.selector') }}" class="hover:text-yellow-400">Not admin?</a>
        </p>
