...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <a href="{{ route('admin.teachers.index') }}" class="mt-4 text-blue-600 hover:text-blue-800 text-sm font-semibold">
                View all →
            </a>
        </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <a href="{{ route('admin.classes.index') }}" class="mt-4 text-green-600 hover:text-green-800 text-sm font-semibold">
                View all →
            </a>
        </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="bg-yellow-100 p-3 rounded-full">
                    <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M5.121 17.804A13.937 13.937 0 0112 15c2.43 0 4.68.65 6.879 1.804M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                </div>
            </div>
            <a href="{{ route('admin.students.index') }}" class="mt-4 text-yellow-600 hover:text-yellow-800 text-sm font-semibold">
                View all →
            </a>
        </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <a href="{{ route('admin.schedules.index') }}" class="mt-4 text-red-600 hover:text-red-800 text-sm font-semibold">
                View all →
            </a>
        </div>
