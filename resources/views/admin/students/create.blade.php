...
<div class="container mx-auto px-4 py-6 max-w-5xl">
  ...
  <div class="flex items-center gap-3 mb-6">
    <a href="{{ route('admin.students.index') }}" class="inline-flex items-center text-gray-600 hover:text-blue-600">
  ...
  <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Add Student</h1>
  <p class="text-gray-600 mb-6">Manually create a new student account</p>
      ...
      <div>
        ...
        <datalist id="class_list">
          ...
          @foreach(($classes ?? \App\Models\SchoolClass::select('id','name','grade_level')->orderBy('grade_level')->get()) as $cls)
            ...
            <option
                data-id="{{ $cls->id }}"
                value="{{ $cls->name }} ({{ $cls->grade_level }})">
            </option>
...
const classSearch =
document.getElementById('class_search');
