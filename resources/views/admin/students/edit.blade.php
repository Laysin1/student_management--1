...
<div class="container mx-auto px-4 py-6 max-w-5xl">
  ...
  <p class="text-gray-600 mb-6">Update student information</p>
  ...
  <form action="{{ route('students.update', $student->id) }}" method="POST" enctype="multipart/form-data"
      ...
      <div>
        ...
        <div class="flex items-center gap-3">
          <label for="profile_photo"
                 class="inline-flex items-center bg-gray-100 hover:bg-gray-200 border border-gray-300 text-gray-800 px-4 py-2 rounded cursor-pointer">
            Browse
          </label>
        ...
        @if($student->profile_photo_path)
          <div class="mt-3">
            <p class="text-sm text-gray-600 mb-1">Current Profile:</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <small class="text-gray-500">Leave empty if you do not want to change the password.</small>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        ...
        <input type="email" name="email" value="{{ old('email', optional($student->user)->email) }}"
               class="border border-gray-300 rounded px-3 py-2 w-full" required>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div>
        ...
        <input type="tel" name="parent_number" value="{{ old('parent_number', $student->parent_number) }}"
               class="border border-gray-300 rounded px-3 py-2 w-full">
      </div>
    </div>
